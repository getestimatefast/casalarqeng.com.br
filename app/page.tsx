import { ArrowRight, Building2, CheckCircle2, ClipboardCheck, Factory, Hammer, Home, Instagram, Mail, MapPin, Phone, Ruler, ShieldCheck, Trees, Wrench } from 'lucide-react';
        ...
        <div className="mx-auto max-w-7xl rounded-[2rem] bg-[#d8c89b] p-8 text-slate-950 md:p-12">
          <div className="grid gap-8 lg:grid-cols-[1fr_.9fr]">
            ...
            <div className="grid content-center gap-4 text-lg">
              ...
              <a href="https://instagram.com/arq.thaisacosaquevite" target="_blank" className="flex items-center gap-3"><Instagram className="h-5 w-5" /> @arq.thaisacosaquevite</a>
